                    ...
                    <div class="default-tab">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Entrada Rápida</a>
                        ...
                        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <form method="POST" action="proc_rapida.php">
                                        <div class="row-1 form-group">
                                            <div class="col col-md-12">
                                                <label for="text-input" class=" form-control-label">Produto ou Serviço</label>
                                            </div>
                                            <div class="col-12 col-md-9">



                                                <select name="id_produto" name="nome" name="valor" name="descricao" class="form-control">
                                                    <?php 
                     ...
                     if ($resultado->num_rows > 0) //se a variavel tiver pelo menos 1 fila entao seguimos com o codigo
                        {
                         ...
                         echo "<option value='".$row['id']."|".$row['nome']."|".$row['valor']."|".$row['descricao']."'>".$row['nome']."  R$ ".$row['valor']."</option>";
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="card-body card-block">
                                    ...
                                    <form method="POST" action="proc_entrada.php">
                                        <div class="row-1 form-group">
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="card-body card-block">
                                    ...
                                    <form method="POST" action="proc_saida.php">
                                        <div class="row-1 form-group">
                                            <div class="col col-md-10">
                                                <label for="text-input" class=" form-control-label">Nome:</label>
                                            </div>
